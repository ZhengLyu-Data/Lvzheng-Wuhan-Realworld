...
# Download script for cleaned data file (iot_sensor_fault_cleaned.csv)

try:
    from google.colab import files
    files.download("iot_sensor_fault_cleaned.csv")
except:
    print("File saved as 'iot_sensor_fault_cleaned.csv'. Please download it manually from the project directory.")
