...
| 05 | NASA Spark IoT Sensor Pipeline<br>美国 NASA 工业传感器故障检测流程分析 | Fault detection and classification based on industrial sensor logs<br>基于NASA工业传感器数据的故障检测与分类分析流程 | Python, PySpark, Seaborn, Matplotlib |
