...
| 07 | Cloud ETL Pipeline Project<br>云端数据处理与 ETL 管道构建项目 | Fault detection and classification based on industrial sensor logs<br>基于工业传感器数据的故障检测与分类分析流程 | Python，PySpark，seaborn, matplotlib |
